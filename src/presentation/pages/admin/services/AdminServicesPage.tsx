...
export default function AdminServicesPage() {
  ...
  const handleImageSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Abrir el ajustador en lugar de aplicar directo
    setAdjustSrc(base64);
    // Resetear el input para que la misma imagen pueda seleccionarse de nuevo
    e.target.value = '';
  };
  ...
  return (
    <Box>
      ...
      {/* ── Ajustador de imagen (se abre encima del diálogo de edición) ── */}
      <ImageAdjuster
        src={adjustSrc ?? ''}
          ...
          <Box sx={{ p: { xs: 2.5, md: 3.5 } }}>
            ...
            <Box sx={{ display: 'flex', gap: 1.5 }}>
              ...
              <Button
                ...
                sx={{
                  bgcolor: success ? '#27AE60' : '#3DAA96',
                  borderRadius: 2,
                  fontWeight: 700,
                  '&:hover': { bgcolor: success ? '#219A52' : '#2B8A78' },
                }}
              >
