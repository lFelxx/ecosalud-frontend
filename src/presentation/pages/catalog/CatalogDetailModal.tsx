...
function ModalImage({ src, icon }: { src: string; icon: ReactNode }) {
  ...
  if (errored) {
    return (
      ...
      >
        <Box sx={{ '& svg': { fontSize: 100, color: 'rgba(255,255,255,0.35)' } }}>
          {icon}
        </Box>
      </Box>
    );
...
export default function CatalogDetailModal({ service, onClose }: Props) {
      ...
      >
        ...
        <Chip
          ...
          sx={{
            ...
            bgcolor: '#E8F5F0', color: '#3DAA96',
            fontWeight: 600, fontSize: '0.78rem',
            border: '1px solid #B2DDD4', borderRadius: '999px', mr: 4,
          }}
        />
        ...
        <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
          <Button
            ...
            sx={{
              flex: 1, minWidth: 140,
              bgcolor: '#3DAA96', borderRadius: 2, fontWeight: 700, py: 1.3, fontSize: '0.95rem',
          ...
          <Button
            ...
            sx={{
              flex: 1, minWidth: 120,
              borderColor: '#C5DDD8', color: '#5A7A74', borderRadius: 2,
              fontWeight: 600, py: 1.3, fontSize: '0.95rem',
